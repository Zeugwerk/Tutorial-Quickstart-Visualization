	...
	namespace Mirror
	{
		...
		public class ZApplication_AxisComPositionPublish
		{
			public ZApplication_AxisComPositionPublish()
			{
				...
				this.IsReferenced = new PLC.Mirror.Primitive<byte>("", null);            
			}        
			...
			public PLC.Mirror.Primitive<byte> IsReferenced { get; set;  }
		}
		...
		public class ZApplication_AxisComBasePublish
		{
			public ZApplication_AxisComBasePublish()
			{
				...
				this.IsSimulated = new PLC.Mirror.Primitive<byte>("", null);
				this.State = new PLC.Mirror.Primitive<PLC.Enums.ZCore_ObjectState>("", null);
				...
				this.IsDrivePowered = new PLC.Mirror.Primitive<byte>("", null);
				this.IsDriveEnabled = new PLC.Mirror.Primitive<byte>("", null);
				this.IsParked = new PLC.Mirror.Primitive<byte>("", null);
			...
			public PLC.Mirror.Primitive<byte> IsSimulated { get; set;  }
			
				  public PLC.Mirror.Primitive<PLC.Enums.ZCore_ObjectState> State { get; set;  }
			...
			public PLC.Mirror.Primitive<byte> IsDrivePowered { get; set;  }
			public PLC.Mirror.Primitive<byte> IsDriveEnabled { get; set;  }
			public PLC.Mirror.Primitive<byte> IsParked { get; set;  }
		...
		public class ZApplication_DigitalComPublish
		{
			public ZApplication_DigitalComPublish()
			{
				...
				this.IoType = new PLC.Mirror.Primitive<PLC.Enums.ZApplication_IoType>("", null);
				this.IsSimulated = new PLC.Mirror.Primitive<byte>("", null);
				this.IsWriteable = new PLC.Mirror.Primitive<byte>("", null);
				this.IsEnabled = new PLC.Mirror.Primitive<byte>("", null);
			...
			public PLC.Mirror.String256 Name { get; set;  }
				  ...
				  public PLC.Mirror.Primitive<PLC.Enums.ZApplication_IoType> IoType { get; set;  }
			public PLC.Mirror.Primitive<byte> IsSimulated { get; set;  }
			public PLC.Mirror.Primitive<byte> IsWriteable { get; set;  }
			public PLC.Mirror.Primitive<byte> IsEnabled { get; set;  }
		...
		public class ZApplication_ActuatorDigitalComPublish
		{
			...
			{
				this.Name = new PLC.Mirror.String256("", null);
				this.IsAtMinus = new PLC.Mirror.Primitive<byte>("", null);
				this.IsAtPlus = new PLC.Mirror.Primitive<byte>("", null);
			...
			public PLC.Mirror.String256 Name { get; set;  }
			public PLC.Mirror.Primitive<byte> IsAtMinus { get; set;  }
			public PLC.Mirror.Primitive<byte> IsAtPlus { get; set;  }
