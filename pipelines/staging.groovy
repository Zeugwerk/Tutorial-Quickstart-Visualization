        ...
        script {
          ...
          dir("bindings/Tutorial_Quickstart") { 
            currentBuild.upstreamBuilds?.each { b -> 
              ...
              copyArtifacts filter: 'bindings/Zeugwerk_Quickstart/Classes.cs,bindings/Zeugwerk_Quickstart/Enums.cs,bindings/Zeugwerk_Quickstart/Structs.cs', projectName: b.getFullProjectName() as String, selector: upstream(), target: '.', flatten: true, optional: false 
            }
          }
    ...
    stage('Build') {
      steps {
        script {
          ...
          def ret = bat returnStdout: true, script: "Godot.exe --no-window --export \"Windows Desktop\" \"${WORKSPACE}\\bin\\Tutorial_Quickstart_Visualization.exe\""
          println ret
